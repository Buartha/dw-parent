...
import com.bidsun.dw.pojo.UserAction;
import com.bidsun.dw.sink.MySqlSink;
import com.bidsun.dw.tools.KafkaProcuder;
...
public class TopNJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        prop.put("bootstrap.servers", KafkaProcuder.BROKER_LIST);
        prop.put("zookeeper.connect", "localhost:2181");
        prop.put("group.id", KafkaProcuder.TOPIC_USER_ACTION);
        prop.put("key.serializer", KafkaProcuder.KEY_SERIALIZER);
        prop.put("value.serializer", KafkaProcuder.VALUE_SERIALIZER);
        prop.put("auto.offset.reset", "latest");

        DataStreamSource<String> dataStreamSource = env.addSource(new FlinkKafkaConsumer010<>(
                KafkaProcuder.TOPIC_USER_ACTION,
    ...
    public static class TopNHotItems extends KeyedProcessFunction<Tuple, ItemBuyCount, List<ItemBuyCount>> {
        ...
        public void onTimer(long timestamp, OnTimerContext ctx, Collector<List<ItemBuyCount>> out) throws Exception {
            ...
            List<ItemBuyCount> itemBuyCounts = new ArrayList<ItemBuyCount>();
