 ...
 */
public class AdsGzhDataApplicationDailyvVisitWindowFunction implements WindowFunction<Integer, AdsGzhDataApplicationDaily, String, TimeWindow> {
    @Override
    public void apply(String  s, TimeWindow window, Iterable<Integer> input, Collector<AdsGzhDataApplicationDaily> out) throws Exception {
        ...
        AdsGzhDataApplicationDaily.setVisit_count(input.iterator().next());
