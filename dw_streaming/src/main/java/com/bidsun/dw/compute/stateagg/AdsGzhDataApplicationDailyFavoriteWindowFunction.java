 ...
 */
public class AdsGzhDataApplicationDailyFavoriteWindowFunction implements WindowFunction<Integer, AdsGzhDataApplicationDaily, String, TimeWindow> {
    @Override
    public void apply(String  s, TimeWindow window, Iterable<Integer> input, Collector<AdsGzhDataApplicationDaily> out) throws Exception {
        ...
        AdsGzhDataApplicationDaily.setFavorite_count(input.iterator().next());
