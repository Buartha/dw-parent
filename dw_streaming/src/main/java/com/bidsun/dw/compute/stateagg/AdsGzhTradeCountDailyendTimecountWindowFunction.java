 ...
 */
public class AdsGzhTradeCountDailyendTimecountWindowFunction implements WindowFunction<Integer, AdsGzhTradeCountDaily, String, TimeWindow> {
    @Override
    public void apply(String  s, TimeWindow window, Iterable<Integer> input, Collector<AdsGzhTradeCountDaily> out) throws Exception {
        ...
        adsGzhTradeCountDaily.setEvaluation_count(input.iterator().next());
