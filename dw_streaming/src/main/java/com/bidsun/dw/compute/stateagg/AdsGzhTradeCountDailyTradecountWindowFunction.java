 ...
 */
public class AdsGzhTradeCountDailyTradecountWindowFunction implements WindowFunction<Integer, com.bidsun.dw.pojo.AdsGzhTradeCountDaily, String, TimeWindow> {
    @Override
