 ...
 */
public class AdsGzhTradeCountDailyTendercountWindowFunction implements WindowFunction<Integer, com.bidsun.dw.pojo.AdsGzhTradeCountDaily, String, TimeWindow> {
    @Override
    public void apply(String  s, TimeWindow window, Iterable<Integer> input, Collector<com.bidsun.dw.pojo.AdsGzhTradeCountDaily> out) throws Exception {
        ...
        adsGzahTradeCountDaily.setTrade_count(input.iterator().next());
