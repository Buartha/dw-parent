 ...
 */
public class AdsGzhDataApplicationDailySubscribeWindowFunction implements WindowFunction<Integer, AdsGzhDataApplicationDaily, String, TimeWindow> {
    @Override
    public void apply(String  s, TimeWindow window, Iterable<Integer> input, Collector<AdsGzhDataApplicationDaily> out) throws Exception {
        ...
        AdsGzhDataApplicationDaily.setSubscribe_count(input.iterator().next());
