 ...
 * @date 2021/6/1 8:45
 */
public class GCJSZiGeYuShenShenQingWenJian implements Serializable {
    ...
    private String applicationValidTime;
    private LocalDateTime docSubmitEndTime;
    private String docSubmitMethod;
    private LocalDateTime docOpenTime;
    private String docOpenMethod;
    ...
    private LocalDateTime postOpenTime;
    ...
    public void setApplicantQualifications(String applicantQualifications) {
    ...
    public void setApplicationValidTime(String applicationValidTime) {
        this.applicationValidTime = applicationValidTime;
    }

    public LocalDateTime getDocSubmitEndTime() {
        return docSubmitEndTime;
    }

    public void setDocSubmitEndTime(LocalDateTime docSubmitEndTime) {
        this.docSubmitEndTime = docSubmitEndTime;
    }
    ...
    public void setDocSubmitMethod(String docSubmitMethod) {
        this.docSubmitMethod = docSubmitMethod;
    }

    public LocalDateTime getDocOpenTime() {
        return docOpenTime;
    }

    public void setDocOpenTime(LocalDateTime docOpenTime) {
        this.docOpenTime = docOpenTime;
    }
    ...
    public void setDocOpenMethod(String docOpenMethod) {
        this.docOpenMethod = docOpenMethod;
    }
    ...
    public LocalDateTime getPostOpenTime() {
        return postOpenTime;
    }

    public void setPostOpenTime(LocalDateTime postOpenTime) {
        this.postOpenTime = postOpenTime;
    }
